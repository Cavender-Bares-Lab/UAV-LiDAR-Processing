...
#' @description Figure S4 that compares the sesonal structural stability among plots
...
#Export figure
jpeg(paste0(root_path, "/Figure_S4.jpeg"), width = 130, height = 180, units = "mm", res = 600)
