################################################################################
#' @title Accumulative growing degree days
################################################################################

#' @description Figure of the accumulative growing degree days for Cedar Cree on
#' 2022
#' 
...
plot <- ggplot(data,
  ...
  ylab("Accumulative growing degree days") +
  theme_bw(base_size = tamano) +
  th


# Export figure
jpeg(paste0(root_path, "/Figure_S_AGDD.jpeg"), width = 100, height = 80, units = "mm", res = 600)
