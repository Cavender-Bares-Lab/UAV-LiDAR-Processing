...
# Taxonomic diversity-----------------------------------------------------------
#HH
HH <- lmer(value ~ log(Diversity)*DOY + (1 | plot_new:Block),
...
#FC
FC <- lmer(value ~ log(Diversity)*DOY + (1 | plot_new:Block),
...
#HH
HH <- lmer(value ~ log(Diversity+1)*DOY + (1 | plot_new:Block),
...
#FC
FC <- lmer(value ~ log(Diversity+1)*DOY + (1 | plot_new:Block),
